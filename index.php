...
<body>
    ...
    <nav class="row menu">
        <ul class="nav justify-content-start flex-rows">
            <li class="nav-item">
                <a class="nav-link active" href="/" aria-current="page">Hibajegy nyitása</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/tickets">Hibajegyek</a>
            </li>
        </ul>
    </nav>
    <main>
